		...
		int verbose_level)
{
	...
	if (it->Canonical_forms->Bitvector_array.size()) {
		...
		combinatorics::canonical_form_classification::any_combinatorial_object *OiP;

		OiP = (combinatorics::canonical_form_classification::any_combinatorial_object *) it->Canonical_forms->Objects[0];
