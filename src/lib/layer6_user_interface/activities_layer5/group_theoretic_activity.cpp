		...
		int verbose_level)
{
	...
	else if (perform_activity_part2(verbose_level)) {

	}

	else if (perform_activity_part3(verbose_level)) {

	}

	else if (perform_activity_part4(verbose_level)) {
...
int group_theoretic_activity::perform_activity_part1(
		int verbose_level)
{
	int f_v = (verbose_level >= 1);

	if (f_v) {
		cout << "group_theoretic_activity::perform_activity_part1" << endl;
	}
	...
	if (f_v) {
		cout << "group_theoretic_activity::perform_activity_part1 done" << endl;
	}
...
int group_theoretic_activity::perform_activity_part2(
		int verbose_level)
{
	int f_v = (verbose_level >= 1);

	if (f_v) {
		cout << "group_theoretic_activity::perform_activity_part2" << endl;
	}
	...
	if (f_v) {
		cout << "group_theoretic_activity::perform_activity_part2 done" << endl;
	}
	return ret;
...
int group_theoretic_activity::perform_activity_part3(
		int verbose_level)
{
	int f_v = (verbose_level >= 1);

	if (f_v) {
		cout << "group_theoretic_activity::perform_activity_part3" << endl;
	}
	...
	if (Descr->f_find_conjugating_element) {
		...
		std::string label;
		layer5_applications::apps_algebra::algebra_global_with_action AGlobal;
		...
		if (f_v) {
			cout << "group_theoretic_activity::perform_activity "
					"before Algebra_global_with_action.diagram_of_elements" << endl;
		}
		Algebra_global_with_action.diagram_of_elements(
				AG,
				verbose_level);
		if (f_v) {
			cout << "group_theoretic_activity::perform_activity "
					"after Algebra_global_with_action.diagram_of_elements" << endl;
		}
		...
		int verbose_level)
{
	...
	if (Descr->f_subgroup_lattice_intersection_orbit_orbit) {
		...
		int verbose_level)
{
	...
	if (Descr->f_subgroup_lattice_magma) {
		if (f_v) {
			cout << "group_theoretic_activity::perform_activity "
		...
		if (f_v) {
			cout << "group_theoretic_activity::perform_activity "
					<< "before Algebra_global_with_action.compute_subgroup_lattice_wrapper" << endl;
		}
		Algebra_global_with_action.compute_subgroup_lattice_wrapper(
				AG,
				Sims,
				verbose_level);
		if (f_v) {
			cout << "group_theoretic_activity::perform_activity "
					<< "after Algebra_global_with_action.compute_subgroup_lattice_wrapper" << endl;
		}
		...
		order_of_overgroup = Descr->find_overgroup_order;

		layer5_applications::apps_algebra::algebra_global_with_action Algebra_global_with_action;

		if (f_v) {
			cout << "group_theoretic_activity::perform_activity "
					<< "before Algebra_global_with_action.find_overgroup_wrapper" << endl;
		}
		Algebra_global_with_action.find_overgroup_wrapper(
				AG,
				Subgroup,
				order_of_overgroup,
				verbose_level);
		if (f_v) {
			cout << "group_theoretic_activity::perform_activity "
					<< "after Algebra_global_with_action.find_overgroup_wrapper" << endl;
		}
		...
		Algebra_global_with_action.find_permutation_subgroup(
				AG,
				Sims,
				verbose_level);
		if (f_v) {
