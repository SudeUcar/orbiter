		...
		int verbose_level)
{
	...
	if (OC->f_has_Orb) {
		...
		layer5_applications::orbits::poset_classification_activity_description *Activity_description;

		Activity_description =
				Get_object_of_type_poset_classification_activity(activity_label);


		layer5_applications::orbits::poset_classification_activity Activity;
		...
		layer5_applications::orbits::orbits_on_subspaces *On_Subspaces = OC->On_Subspaces;
