...
interface_algebra::interface_algebra()
{
	...
	f_smith_normal_form_from_the_left_only = false;
		...
		std::string *argv, int i, int verbose_level)
{
	...
	else if (ST.stringcmp(argv[i], "-smith_normal_form_from_the_left_only") == 0) {
		cout << "-smith_normal_form_from_the_left_only <string : matrix_label>" << endl;
	}
		...
		std::string *argv, int &i, int verbose_level)
{
	...
	// TABLES/interface_algebra.csv
		...
		f_smith_normal_form_from_the_left_only = true;
		smith_normal_form_from_the_left_only_matrix.assign(argv[++i]);
		if (f_v) {
			cout << "-smith_normal_form_from_the_left_only "
				<< smith_normal_form_from_the_left_only_matrix << endl;
		}
	}
...
void interface_algebra::print()
{
	...
	if (f_smith_normal_form_from_the_left_only) {
		cout << "-smith_normal_form_from_the_left_only "
			<< smith_normal_form_from_the_left_only_matrix << endl;
	}
...
// called from orbiter_command::execute
{
	...
	// TABLES/interface_algebra.csv
		...
		Algebra.smith_normal_form(
					A, m, n, smith_normal_form_matrix,
					M, P, Pv, Q, Qv,
					verbose_level);
		if (f_v) {
			cout << "interface_algebra::worker "
	...
	else if (f_smith_normal_form_from_the_left_only) {


		if (f_v) {
			cout << "interface_algebra::worker f_smith_normal_form_from_the_left_only" << endl;
		}
		...
		Get_matrix(smith_normal_form_from_the_left_only_matrix, A, m, n);
		...
		if (f_v) {
			cout << "interface_algebra::worker "
					"before Algebra.smith_normal_form_from_the_left_only" << endl;
		}
		Algebra.smith_normal_form_from_the_left_only(
					A, m, n, smith_normal_form_matrix,
					M, P, Pv,
					verbose_level);
		if (f_v) {
			cout << "interface_algebra::worker "
					"after Algebra.smith_normal_form_from_the_left_only" << endl;
		}
		...
		algebra::ring_theory::ring_theory_global Ring_theory_global;

		other::data_structures::int_matrix *C;

		if (f_v) {
			cout << "interface_algebra::worker "
					"before Ring_theory_global.multiply_int_matrices" << endl;
		}
		Ring_theory_global.multiply_int_matrices(
				Pv,
				M,
				C,
				verbose_level);
		if (f_v) {
			cout << "interface_algebra::worker "
					"after Ring_theory_global.multiply_int_matrices" << endl;
		}
	...
	// representation theory:
		...
		layer5_applications::apps_algebra::algebra_global_with_action A;
		...
		layer5_applications::apps_algebra::algebra_global_with_action Algebra;
